            ...
            <div class="col-lg-4">
            	<div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="client_css/img/trash/10.png">
                            ...
                            <div class="user-btm-box">
                                <div class="col-md-6 col-sm-6 text-center">
                                    ...
                                    <h2>{{ $profile->posts->count('name')}}</h2> </div>
                                <div class="col-md-6 col-sm-6 text-center">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="posts">
                            	...
                            	<div class="list-group">
                                 @foreach($profile->posts as $item)
                                        <a href="{{ route('single-post', [$item->category->Url,$item->FriendlyTitle,$item->category->id,$item->id]) }}"><p><i class="fa fa-arrow-circle-right"></i> {{$item->Title}} </p></a>
