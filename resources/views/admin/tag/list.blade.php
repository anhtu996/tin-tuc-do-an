        ...
        <div class="modal-body">
            <form id="form-update">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="slug" name="FriendlyTitle">
                </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="form-add">
                ...
                <div class="form-group">
                    <label for="recipient-name" class="control-label">Tên Tags</label>
                    <input type="text" class="form-control" id="tag-name-add" name="Title">
                </div>
                <div class="form-group">
                    <label for="recipient-name" class="control-label">Đường dẫn</label>
                    <input type="text" class="form-control" id="slug-add" name="FriendlyTitle">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
    ...
    $(document).ready(function() {
        ...
        var datatable = $('#tag_list').DataTable({
            ...
            columns: [
                ...
                { data: 'FriendlyTitle', name: 'FriendlyTitle' },
