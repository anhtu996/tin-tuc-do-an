        ...
        <div class="modal-body">
            <form id="form-update">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="cate-name" name="Name">
                </div>
                <div class="form-group">
 ...
 <script type="text/javascript">
    $(document).ready(function() {
        ...
        var datatable = $('#cate_list').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! route('data-cate') !!}',
            columns: [
                { data: 'id', name: 'id' },
                { data: 'Name', name: 'Name' },
                { data: 'Url', name: 'Url' },
                { data: 'IsSubCategory', name: 'IsSubCategory' },
        ...
        $('#show-update').on('show.bs.modal', function (event) {
            ...
            var slug=currentRow.find("td:eq(2)").text(); // get current row 3nd TD
            var parent=currentRow.find("td:eq(4)").text(); // get current row 5rd TD
            var modal = $(this);
